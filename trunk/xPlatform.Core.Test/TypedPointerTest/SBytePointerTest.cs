...
{
    [TestFixture]
    public class SBytePointerTest : AssertionHelper
    {
        private Random random = new Random();

        public sbyte GenerateRandomNumber()
        {
        ...
        public unsafe void StackallocTest6()
        {
            ...
            // Pointer conversion test
            for (int i = 0; i < bufferSize; i++)
                results[i] = *(sbyte*)(pointer + i) = GenerateRandomNumber();
        ...
        public unsafe void SizeOfTest1()
        {
            ...
            int ptrSize1 = Marshal.SizeOf(new SBytePointer(sample));
            Console.WriteLine("Marshal.SizeOf(new SBytePointer(...)): {0}", ptrSize1);
            totalSize += ptrSize1;

            int ptrSize2 = Marshal.SizeOf(typeof(SBytePointer));
            Console.WriteLine("Marshal.SizeOf(typeof(SBytePointer)): {0}", ptrSize2);
            totalSize += ptrSize2;
            ...
            int ptrSize5 = Marshal.SizeOf(typeof(sbyte*));
            Console.WriteLine("Marshal.SizeOf(typeof(sbyte*)): {0}", ptrSize5);
            totalSize += ptrSize5;

            Assert.AreEqual(totalSize, SBytePointer.Size * 5);
        }
        ...
        public unsafe void SizeOfTest2()
        {
            ...
            int ptrSize1 = sizeof(SBytePointer);
            Console.WriteLine("sizeof(SBytePointer): {0}", ptrSize1);
            totalSize += ptrSize1;
            ...
            int ptrSize3 = sizeof(sbyte*);
            Console.WriteLine("sizeof(sbyte*): {0}", ptrSize3);
            totalSize += ptrSize3;

            Assert.AreEqual(totalSize, SBytePointer.Size * 3);
        }
