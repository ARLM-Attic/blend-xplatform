...
{
    [TestFixture]
    public class UInt64PointerTest : AssertionHelper
    {
        ...
        public unsafe void StackallocTest1()
        {
            ...
            ulong* sample = stackalloc ulong[bufferSize];
            UInt64Pointer pointer = new UInt64Pointer(sample);
            ulong[] results = new ulong[bufferSize];
        ...
        public unsafe void StackallocTest6()
        {
            ...
            // Pointer conversion test
            for (int i = 0; i < bufferSize; i++)
                results[i] = *(ulong*)(pointer + i) = GenerateRandomNumber();
        ...
        {
            ulong* sample = stackalloc ulong[4];

            int totalSize = 0;

            int ptrSize1 = Marshal.SizeOf(new UInt64Pointer(sample));
            Console.WriteLine("Marshal.SizeOf(new UInt64Pointer(...)): {0}", ptrSize1);
            totalSize += ptrSize1;

            int ptrSize2 = Marshal.SizeOf(typeof(UInt64Pointer));
            Console.WriteLine("Marshal.SizeOf(typeof(UInt64Pointer)): {0}", ptrSize2);
            totalSize += ptrSize2;
            ...
            int ptrSize5 = Marshal.SizeOf(typeof(ulong*));
            Console.WriteLine("Marshal.SizeOf(typeof(ulong*)): {0}", ptrSize5);
            totalSize += ptrSize5;

            Assert.AreEqual(totalSize, UInt64Pointer.Size * 5);
        }
        ...
        public unsafe void SizeOfTest2()
        {
            ...
            int ptrSize1 = sizeof(UInt64Pointer);
            Console.WriteLine("sizeof(UInt64Pointer): {0}", ptrSize1);
            totalSize += ptrSize1;
            ...
            int ptrSize3 = sizeof(ulong*);
            Console.WriteLine("sizeof(ulong*): {0}", ptrSize3);
            totalSize += ptrSize3;

            Assert.AreEqual(totalSize, UInt64Pointer.Size * 3);
        }
        ...
        public unsafe void EqualityTest1()
        {
            ...
            UInt64Pointer address3 = new UInt64Pointer(address2);
            Console.WriteLine("UInt64Pointer Address (from IntPtr): {0:X}", address3.ToInt32());
            checksum += address3.ToInt32();

            UInt64Pointer address4 = new UInt64Pointer(address1);
            Console.WriteLine("UInt64Pointer Address (from Int32): {0:X}", address4.ToInt32());
