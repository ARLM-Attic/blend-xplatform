...
{
    [TestFixture]
    public class Int32PointerTest : AssertionHelper
    {
        ...
        public unsafe void StackallocTest1()
        {
            ...
            int* sample = stackalloc int[bufferSize];
            Int32Pointer pointer = new Int32Pointer(sample);
        ...
        public unsafe void StackallocTest6()
        {
            ...
            // Pointer conversion test
            for (int i = 0; i < bufferSize; i++)
                results[i] = *(int*)(pointer + i) = GenerateRandomNumber();
        ...
        {
            int* sample = stackalloc int[4];

            int totalSize = 0;

            int ptrSize1 = Marshal.SizeOf(new Int32Pointer(sample));
            Console.WriteLine("Marshal.SizeOf(new Int32Pointer(...)): {0}", ptrSize1);
            totalSize += ptrSize1;

            int ptrSize2 = Marshal.SizeOf(typeof(Int32Pointer));
            Console.WriteLine("Marshal.SizeOf(typeof(Int32Pointer)): {0}", ptrSize2);
            totalSize += ptrSize2;
            ...
            int ptrSize5 = Marshal.SizeOf(typeof(int*));
            Console.WriteLine("Marshal.SizeOf(typeof(int*)): {0}", ptrSize5);
            totalSize += ptrSize5;

            Assert.AreEqual(totalSize, Int32Pointer.Size * 5);
        }
        ...
        public unsafe void SizeOfTest2()
        {
            ...
            int ptrSize1 = sizeof(Int32Pointer);
            Console.WriteLine("sizeof(Int32Pointer): {0}", ptrSize1);
            totalSize += ptrSize1;
            ...
            int ptrSize3 = sizeof(int*);
            Console.WriteLine("sizeof(int*): {0}", ptrSize3);
            totalSize += ptrSize3;

            Assert.AreEqual(totalSize, Int32Pointer.Size * 3);
        }
        ...
        public unsafe void EqualityTest1()
        {
            ...
            Int32Pointer address3 = new Int32Pointer(address2);
            Console.WriteLine("Int32Pointer Address (from IntPtr): {0:X}", address3.ToInt32());
            checksum += address3.ToInt32();

            Int32Pointer address4 = new Int32Pointer(address1);
            Console.WriteLine("Int32Pointer Address (from Int32): {0:X}", address4.ToInt32());
