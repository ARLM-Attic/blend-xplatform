...
{
    [TestFixture]
    public class IntPtrPointerTest : AssertionHelper
    {
        private Random random = new Random();

        public IntPtr GenerateRandomNumber()
        {
            return new IntPtr(random.Next());
        }
        ...
        public unsafe void StackallocTest1()
        {
            ...
            IntPtr* sample = stackalloc IntPtr[bufferSize];
            IntPtrPointer pointer = new IntPtrPointer(sample);
            IntPtr[] results = new IntPtr[bufferSize];
        ...
        public unsafe void StackallocTest6()
        {
            ...
            // Pointer conversion test
            for (int i = 0; i < bufferSize; i++)
                results[i] = *(IntPtr*)(pointer + i) = GenerateRandomNumber();
        ...
        public unsafe void SizeOfTest1()
        {
            ...
            int ptrSize1 = Marshal.SizeOf(new IntPtrPointer(sample));
            Console.WriteLine("Marshal.SizeOf(new IntPtrPointer(...)): {0}", ptrSize1);
            totalSize += ptrSize1;

            int ptrSize2 = Marshal.SizeOf(typeof(IntPtrPointer));
            Console.WriteLine("Marshal.SizeOf(typeof(IntPtrPointer)): {0}", ptrSize2);
            totalSize += ptrSize2;
            ...
            int ptrSize5 = Marshal.SizeOf(typeof(IntPtr*));
            Console.WriteLine("Marshal.SizeOf(typeof(IntPtr*)): {0}", ptrSize5);
            totalSize += ptrSize5;

            Assert.AreEqual(totalSize, IntPtrPointer.Size * 5);
        }
        ...
        public unsafe void SizeOfTest2()
        {
            ...
            int ptrSize1 = sizeof(IntPtrPointer);
            Console.WriteLine("sizeof(IntPtrPointer): {0}", ptrSize1);
            totalSize += ptrSize1;
            ...
            int ptrSize3 = sizeof(IntPtr*);
            Console.WriteLine("sizeof(IntPtr*): {0}", ptrSize3);
            totalSize += ptrSize3;

            Assert.AreEqual(totalSize, IntPtrPointer.Size * 3);
        }
