...
namespace xPlatform.Test.TypedPointerTest
{
    ...
    public class BytePointerTest : AssertionHelper
    {
        ...
        public unsafe void SizeOfTest2()
        {
            ...
            int ptrSize1 = sizeof(BytePointer);
            Console.WriteLine("sizeof(BytePointer): {0}", ptrSize1);
            totalSize += ptrSize1;
            ...
            int ptrSize3 = sizeof(byte*);
            Console.WriteLine("sizeof(byte*): {0}", ptrSize3);
            totalSize += ptrSize3;

            Assert.AreEqual(totalSize, BytePointer.Size * 3);
        }
